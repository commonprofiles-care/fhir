Instance: OuterBlockWithExceptionsExample
InstanceOf: ConsentBlockSE
Description: "Example instance of an outer block with exceptions for prescribed medications and attention signal information."
...
* provision.provision[permitData].period.start = "2022-02-07T13:28:17.239+02:00"
...
* provision.provision[permitData].type = #permit 
* provision.provision[permitData].actor[grantorPersonnummer].role = http://terminology.hl7.org/CodeSystem/v3-RoleCode#GRANTOR
...
* provision.provision[permitData].actor[grantorPersonnummer].reference.identifier.value = "191212121212"
